module.exports = {
  ...
  execute(client, message, args, db) {
    ...
    if (message.author.id == memberToKick.id)
      return message.reply("You can't kick yourself!"); // Checks if the user mentioned themself
    ...
    if (!message.member.hasPermission(['ADMINISTRATOR'])) {
      ...
      if (!targetRole.comparePositionTo(authorRole) <= 0)
        ...
        ); // https://stackoverflow.com/questions/64056025/discord-js-ban-user-permissions-command
    }
